...
# Use a different env var for tests to avoid SQLAlchemy format conflict
DATABASE_URL = os.getenv("TEST_DATABASE_URL", "postgresql://emr_user:emr_password@postgres:5432/emr_db")
