#!/usr/bin/env python3
"""
Apply all fixes discovered during AWS deployment to local repository.
This is a local version of apply_aws_fixes.py that works in development.

Usage:
    python scripts/apply_local_fixes.py [--check-only]
"""
...
async def main():
    ...
    fixer = LocalFixes(check_only=check_only)
    await fixer.run()
