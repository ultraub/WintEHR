#!/usr/bin/env python3
"""
Official FHIR StructureMap-based CarePlan R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/CarePlan4to5
- http://hl7.org/fhir/StructureMap/CarePlan5to4
...
class CarePlanConverter:
    """
    Official StructureMap-based converter for CarePlan resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert CarePlan from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 CarePlan resource
            
        Returns:
            R5 CarePlan resource
            
        Raises:
            ValueError: If resource is not CarePlan
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert CarePlan from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 CarePlan resource
            
        Returns:
            R4 CarePlan resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/CarePlan.json"
...
async def convert_care_plan_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 CarePlan resource
...
async def convert_care_plan_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 CarePlan resource
...
__all__ = [
    "CarePlanConverter",
    "convert_care_plan_r4_to_r5", 
    "convert_care_plan_r5_to_r4"
]