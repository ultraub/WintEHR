#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Flag R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Flag4to5
- http://hl7.org/fhir/StructureMap/Flag5to4
...
class FlagConverter:
    """
    Official StructureMap-based converter for Flag resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Flag from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Flag resource
            
        Returns:
            R5 Flag resource
            
        Raises:
            ValueError: If resource is not Flag
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Flag from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Flag resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Flag.json"
...
async def convert_flag_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Flag resource
...
async def convert_flag_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Flag resource
...
__all__ = [
    "FlagConverter",
    "convert_flag_r4_to_r5", 
    "convert_flag_r5_to_r4"
]