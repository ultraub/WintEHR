#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Practitioner R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Practitioner4to5
- http://hl7.org/fhir/StructureMap/Practitioner5to4
...
class PractitionerConverter:
    """
    Official StructureMap-based converter for Practitioner resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Practitioner from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Practitioner resource
            
        Returns:
            R5 Practitioner resource
            
        Raises:
            ValueError: If resource is not Practitioner
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Practitioner from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Practitioner resource
            
        Returns:
            R4 Practitioner resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Practitioner.json"
...
async def convert_practitioner_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Practitioner resource
        
    Returns:
        R5 Practitioner resource
    """
    converter = PractitionerConverter()
    return converter.convert_r4_to_r5(resource_data)


async def convert_practitioner_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Practitioner resource
...
__all__ = [
    ...
    "convert_practitioner_r4_to_r5", 
    "convert_practitioner_r5_to_r4"
]