#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Encounter R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Encounter4to5
- http://hl7.org/fhir/StructureMap/Encounter5to4
...
class EncounterConverter:
    """
    Official StructureMap-based converter for Encounter resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Encounter from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Encounter resource
            
        Returns:
            R5 Encounter resource
            
        Raises:
            ValueError: If resource is not Encounter
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Encounter from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Encounter resource
            
        Returns:
            R4 Encounter resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Encounter.json"
...
async def convert_encounter_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Encounter resource
...
async def convert_encounter_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Encounter resource
...
__all__ = [
    "EncounterConverter",
    "convert_encounter_r4_to_r5", 
    "convert_encounter_r5_to_r4"
]