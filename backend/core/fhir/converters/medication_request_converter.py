#!/usr/bin/env python3
"""
Official FHIR StructureMap-based MedicationRequest R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/MedicationRequest4to5
- http://hl7.org/fhir/StructureMap/MedicationRequest5to4
...
class MedicationRequestConverter:
    """
    Official StructureMap-based converter for MedicationRequest resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert MedicationRequest from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 MedicationRequest resource
            
        Returns:
            R5 MedicationRequest resource
            
        Raises:
            ValueError: If resource is not MedicationRequest
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert MedicationRequest from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 MedicationRequest resource
            
        Returns:
            R4 MedicationRequest resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/MedicationRequest.json"
...
async def convert_medication_request_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 MedicationRequest resource
...
async def convert_medication_request_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 MedicationRequest resource
...
__all__ = [
    ...
    "convert_medication_request_r4_to_r5", 
    "convert_medication_request_r5_to_r4"
]