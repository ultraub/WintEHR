#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Immunization R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Immunization4to5
- http://hl7.org/fhir/StructureMap/Immunization5to4
...
class ImmunizationConverter:
    """
    Official StructureMap-based converter for Immunization resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Immunization from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Immunization resource
            
        Returns:
            R5 Immunization resource
            
        Raises:
            ValueError: If resource is not Immunization
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Immunization from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Immunization resource
            
        Returns:
            R4 Immunization resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Immunization.json"
...
async def convert_immunization_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Immunization resource
...
async def convert_immunization_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Immunization resource
...
__all__ = [
    ...
    "convert_immunization_r4_to_r5", 
    "convert_immunization_r5_to_r4"
]