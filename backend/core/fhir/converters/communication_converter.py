#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Communication R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Communication4to5
- http://hl7.org/fhir/StructureMap/Communication5to4
...
class CommunicationConverter:
    """
    Official StructureMap-based converter for Communication resources
    ...
    def __init__(self):
        ...
        self.resource_type = "Communication"
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Communication from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Communication resource
            
        Returns:
            R5 Communication resource
            
        Raises:
            ValueError: If resource is not Communication
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Communication from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Communication resource
            
        Returns:
            R4 Communication resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Communication.json"
...
async def convert_communication_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Communication resource
...
async def convert_communication_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Communication resource
...
__all__ = [
    ...
    "convert_communication_r4_to_r5", 
    "convert_communication_r5_to_r4"
]