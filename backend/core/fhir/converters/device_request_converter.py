#!/usr/bin/env python3
"""
Official FHIR StructureMap-based DeviceRequest R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/DeviceRequest4to5
- http://hl7.org/fhir/StructureMap/DeviceRequest5to4
...
class DeviceRequestConverter:
    """
    Official StructureMap-based converter for DeviceRequest resources
    ...
    def __init__(self):
        ...
        self.resource_type = "DeviceRequest"
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert DeviceRequest from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 DeviceRequest resource
            
        Returns:
            R5 DeviceRequest resource
            
        Raises:
            ValueError: If resource is not DeviceRequest
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert DeviceRequest from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 DeviceRequest resource
            
        Returns:
            R4 DeviceRequest resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/DeviceRequest.json"
...
async def convert_device_request_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 DeviceRequest resource
        
    Returns:
        R5 DeviceRequest resource
    """
    converter = DeviceRequestConverter()
    return converter.convert_r4_to_r5(resource_data)


async def convert_device_request_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 DeviceRequest resource
...
__all__ = [
    ...
    "convert_device_request_r4_to_r5", 
    "convert_device_request_r5_to_r4"
]