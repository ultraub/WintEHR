#!/usr/bin/env python3
"""
Official FHIR StructureMap-based MedicationAdministration R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/MedicationAdministration4to5
- http://hl7.org/fhir/StructureMap/MedicationAdministration5to4
...
class MedicationAdministrationConverter:
    """
    Official StructureMap-based converter for MedicationAdministration resources
    ...
    def __init__(self):
        ...
        self.resource_type = "MedicationAdministration"
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert MedicationAdministration from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 MedicationAdministration resource
            
        Returns:
            R5 MedicationAdministration resource
            
        Raises:
            ValueError: If resource is not MedicationAdministration
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert MedicationAdministration from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 MedicationAdministration resource
            
        Returns:
            R4 MedicationAdministration resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/MedicationAdministration.json"
...
async def convert_medication_administration_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 MedicationAdministration resource
        
    Returns:
        R5 MedicationAdministration resource
    """
    converter = MedicationAdministrationConverter()
    return converter.convert_r4_to_r5(resource_data)


async def convert_medication_administration_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 MedicationAdministration resource
...
__all__ = [
    ...
    "convert_medication_administration_r4_to_r5", 
    "convert_medication_administration_r5_to_r4"
]