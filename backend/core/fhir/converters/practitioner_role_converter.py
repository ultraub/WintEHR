#!/usr/bin/env python3
"""
Official FHIR StructureMap-based PractitionerRole R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/PractitionerRole4to5
...
class PractitionerRoleConverter:
    """
    Official StructureMap-based converter for PractitionerRole resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert PractitionerRole from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 PractitionerRole resource
            
        Returns:
            R5 PractitionerRole resource
            
        Raises:
            ValueError: If resource is not PractitionerRole
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert PractitionerRole from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 PractitionerRole resource
            
        Returns:
            R4 PractitionerRole resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/PractitionerRole.json"
...
async def convert_practitioner_role_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 PractitionerRole resource
...
async def convert_practitioner_role_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 PractitionerRole resource
...
__all__ = [
    ...
    "convert_practitioner_role_r4_to_r5", 
    "convert_practitioner_role_r5_to_r4"
]