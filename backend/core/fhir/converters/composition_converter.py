#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Composition R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Composition4to5
- http://hl7.org/fhir/StructureMap/Composition5to4
...
class CompositionConverter:
    """
    Official StructureMap-based converter for Composition resources
    ...
    def __init__(self):
        ...
        self.resource_type = "Composition"
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Composition from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Composition resource
            
        Returns:
            R5 Composition resource
            
        Raises:
            ValueError: If resource is not Composition
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Composition from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Composition resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Composition.json"
...
async def convert_composition_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Composition resource
...
async def convert_composition_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Composition resource
...
__all__ = [
    ...
    "convert_composition_r4_to_r5", 
    "convert_composition_r5_to_r4"
]