#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Coverage R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Coverage4to5
- http://hl7.org/fhir/StructureMap/Coverage5to4
...
class CoverageConverter:
    """
    Official StructureMap-based converter for Coverage resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Coverage from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Coverage resource
            
        Returns:
            R5 Coverage resource
            
        Raises:
            ValueError: If resource is not Coverage
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Coverage from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Coverage resource
            
        Returns:
            R4 Coverage resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Coverage.json"
...
async def convert_coverage_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Coverage resource
...
async def convert_coverage_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Coverage resource
...
__all__ = [
    "CoverageConverter",
    "convert_coverage_r4_to_r5", 
    "convert_coverage_r5_to_r4"
]