#!/usr/bin/env python3
"""
Official FHIR StructureMap-based CareTeam R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/CareTeam4to5
- http://hl7.org/fhir/StructureMap/CareTeam5to4
...
class CareTeamConverter:
    """
    Official StructureMap-based converter for CareTeam resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert CareTeam from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 CareTeam resource
            
        Returns:
            R5 CareTeam resource
            
        Raises:
            ValueError: If resource is not CareTeam
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert CareTeam from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 CareTeam resource
            
        Returns:
            R4 CareTeam resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/CareTeam.json"
...
async def convert_care_team_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 CareTeam resource
...
async def convert_care_team_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 CareTeam resource
...
__all__ = [
    "CareTeamConverter",
    "convert_care_team_r4_to_r5", 
    "convert_care_team_r5_to_r4"
]