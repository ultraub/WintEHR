#!/usr/bin/env python3
"""
Official FHIR StructureMap-based Location R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/Location4to5
- http://hl7.org/fhir/StructureMap/Location5to4
...
class LocationConverter:
    """
    Official StructureMap-based converter for Location resources
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Location from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 Location resource
            
        Returns:
            R5 Location resource
            
        Raises:
            ValueError: If resource is not Location
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert Location from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 Location resource
            
        Returns:
            R4 Location resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/Location.json"
...
async def convert_location_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 Location resource
...
async def convert_location_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 Location resource
...
__all__ = [
    "LocationConverter",
    "convert_location_r4_to_r5", 
    "convert_location_r5_to_r4"
]