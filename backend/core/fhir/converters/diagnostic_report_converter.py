#!/usr/bin/env python3
"""
Official FHIR StructureMap-based DiagnosticReport R4↔R5 converter

Implements the official HL7 StructureMap transformations:
- http://hl7.org/fhir/StructureMap/DiagnosticReport4to5
...
class DiagnosticReportConverter:
    """
    Official StructureMap-based converter for DiagnosticReport resources
    ...
    def __init__(self):
        ...
        self.resource_type = "DiagnosticReport"
    ...
    def convert_r4_to_r5(self, r4_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert DiagnosticReport from R4 to R5 format using official StructureMap
        
        Args:
            r4_resource: R4 DiagnosticReport resource
            
        Returns:
            R5 DiagnosticReport resource
            
        Raises:
            ValueError: If resource is not DiagnosticReport
        """
    ...
    def convert_r5_to_r4(self, r5_resource: Dict[str, Any]) -> Dict[str, Any]:
        """
        Convert DiagnosticReport from R5 to R4 format using official StructureMap
        
        Args:
            r5_resource: R5 DiagnosticReport resource
            
        Returns:
            R4 DiagnosticReport resource
    ...
    def test_with_official_example(cls) -> Dict[str, Any]:
        ...
        base_dir = Path(__file__).parent.parent
        r4_example_path = base_dir / "official_resources/r4/DiagnosticReport.json"
...
async def convert_diagnostic_report_r4_to_r5(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R4 DiagnosticReport resource
        
    Returns:
        R5 DiagnosticReport resource
    """
    converter = DiagnosticReportConverter()
    return converter.convert_r4_to_r5(resource_data)


async def convert_diagnostic_report_r5_to_r4(resource_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    Async wrapper for version-aware storage integration
    
    Args:
        resource_data: R5 DiagnosticReport resource
...
__all__ = [
    ...
    "convert_diagnostic_report_r4_to_r5", 
    "convert_diagnostic_report_r5_to_r4"
]