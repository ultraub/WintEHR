...
def register_all_routers(app: FastAPI) -> None:
    ...
    try:
        ...
        from api.cds_studio.value_set_composer import router as value_set_composer_router
        ...
        app.include_router(value_set_composer_router, tags=["CDS Studio — ValueSets"])
