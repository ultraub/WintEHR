...
from shared.exceptions import DatabaseQueryError
...
class FeedbackPersistenceManager:
    ...
    async def store_feedback(self,
        ...
        try:
            ...
            raise DatabaseQueryError(message="Failed to store feedback", cause=e)
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            await self.db.rollback()
            logger.error(f"Data error storing feedback: {e}")
            raise
    ...
    async def store_bulk_feedback(self, feedback_items: List[Dict[str, Any]]) -> List[str]:
        ...
        try:
            ...
            await self.db.rollback()
            logger.error(f"Database error storing bulk feedback: {e}")
            raise DatabaseQueryError(message="Failed to store bulk feedback", cause=e)
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            await self.db.rollback()
            logger.error(f"Data error storing bulk feedback: {e}")
            raise
    ...
    async def get_feedback_by_service(self,
        ...
        try:
            ...
            logger.error(f"Database error retrieving feedback for service {service_id}: {e}")
            return []
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            logger.error(f"Data error retrieving feedback for service {service_id}: {e}")
            return []
    ...
    async def get_feedback_by_patient(self,
        ...
        try:
            ...
            logger.error(f"Database error retrieving feedback for patient {patient_id}: {e}")
            return []
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            logger.error(f"Data error retrieving feedback for patient {patient_id}: {e}")
            return []
    ...
    async def get_feedback_by_user(self,
        ...
        try:
            ...
            logger.error(f"Database error retrieving feedback for user {user_id}: {e}")
            return []
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            logger.error(f"Data error retrieving feedback for user {user_id}: {e}")
            return []
    ...
    async def get_analytics_summary(self,
        ...
        try:
            ...
            logger.error(f"Data error getting analytics summary: {e}")
            return {}
    ...
    async def _update_analytics(self,
        ...
        try:
            ...
            await self.db.rollback()
            logger.error(f"Database error updating analytics: {e}")
        except (ValueError, TypeError, KeyError) as e:
            await self.db.rollback()
            logger.error(f"Data error updating analytics: {e}")
    ...
    async def _update_acceptance_rate(self, service_id: str, period_start: datetime, period_end: datetime):
        ...
        try:
            ...
            logger.error(f"Database error updating acceptance rate: {e}")
        except (ValueError, TypeError) as e:
            logger.error(f"Data error updating acceptance rate: {e}")
    ...
    async def _update_override_reasons(self,
        ...
        try:
            ...
            logger.error(f"Database error updating override reasons: {e}")
        except (json.JSONDecodeError, ValueError, TypeError, KeyError) as e:
            logger.error(f"Data error updating override reasons: {e}")
...
async def process_cds_feedback(db: AsyncSession, feedback_data: Dict[str, Any]) -> str:
    ...
    try:
        ...
        logger.error(f"Data error processing CDS feedback: {e}")
        raise
...
async def get_service_analytics(db: AsyncSession, service_id: str, days: int = 30) -> Dict[str, Any]:
    ...
    try:
        ...
        logger.error(f"Database error getting service analytics: {e}")
        return {}
    except (ValueError, TypeError, KeyError) as e:
