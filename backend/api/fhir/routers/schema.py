...
# Path to FHIR resource definitions (relative to backend/)
RESOURCE_DEFINITIONS_PATH = Path(__file__).parent.parent.parent.parent / "fhir" / "resource_definitions" / "official_resources" / "r4"
